...
m = 23.464476550636586
v = 49.59610108358432


def normal_dist(x, mean=m, vari=v):
...
def expected_normal_dist(x, mean=m, vari=v):
...
def laplace_dist(x, mean=m, vari=v):
...
def expected_laplace_dist(x, mean=m, vari=v):
