from qLearning import generateClusters, RealizationMap, generateNoiseVectors, qLearning
from LDPC_decoding import BToHamm
from applyQlearning import beliefPropogation
import pickle
import numpy as np
...
qLearning(H, lmax, e, clusters, M, numberOfVectors, EsN0, 0, name)
...
for _ in range(numberOfTrials):
	...
	l = beliefPropogation(generateNoiseVectors(len(H[0]), 1, 1)[0], H, Q, clusters, realizationMap, M, lmax, repre, thre)
	if l: decoded+=1
